window.addEventListener("DOMContentLoaded",() => {
    let range1 = new RollCounterRange("#range1"),
        ...
        range8 = new RollCounterRange("#range8"),
        range9 = new RollCounterRange("#range9"),
        range10 = new RollCounterRange("#range10"),
        range11 = new RollCounterRange("#range11"),
        range12 = new RollCounterRange("#range12"),
        range13 = new RollCounterRange("#range13"),
        range14 = new RollCounterRange("#range14"),
        range15 = new RollCounterRange("#range15"),
        range16 = new RollCounterRange("#range16");
});
...
class RollCounterRange {
    ...
    changeValue() {
        ...
        if (this.fill) {
            ...
            this.fill.style.width = `calc(${fillWidth-3}% + ${thumbEm}em)`;
        }
